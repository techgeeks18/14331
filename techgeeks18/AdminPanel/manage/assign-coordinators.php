            ...
            <thead>
                ...
                if(count($pageList)>=1)
                {
                    foreach ($pageList as $value){
                        echo '<tr>
                        <td>'.$value["eid"].'</td> <td>'.$value["ename"].'</td> <td>'.$value["description"].'</td> <td> echo '<input type="textbox"' <td>'.$value["fname"].'</td> <td>'.$value["lname"] '<td> <input type="submit" name="submit" value="assign" >
                        </tr>';
                    }
                }
                ?>
