...
class loginClass extends connectionClass{
    public function checkLogin($username, $password) {
        $select="select * from volunteer where mobilenumber='$username' && Password=md5('$password')";
    ...
    public function sessionLogin(){
        ...
        $select= "select * from volunteer where mobilenumber='$username' && Password='$password'";
